...
Create table  Actions (user_id int, post_id int, action_date date, action varchar2(50), extra varchar(10));
...
select ROUND(AVG(total_removed/total_post)*100,2)average_daily_percent
FROM
(
    SELECT
    a.action_date,
    count(DISTINCT r.post_id) as total_removed,
